{/* <section className="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
    <header>
        <a href="#">
            <img className="w-auto mx-auto h-7 sm:h-8" src="https://merakiui.com/images/full-logo.svg" alt="" />
        </a>
    </header>
    ...
    <footer className="mt-8 text-center">
        ...
        <p className="mt-2 text-gray-500 dark:text-gray-400">Get the most of Meraki UI by installing our new mobile app.</p>

        <div className="mt-6">
            <a href="#" className="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                <svg className="w-5 h-5 mx-2 fill-current" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <g>
            ...
            <a href="#" className="inline-flex items-center justify-center w-full px-4 py-2.5 mt-4 text-sm overflow-hidden text-white transition-colors duration-300 bg-blue-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
        ...
        <p className="mt-3 text-gray-500 dark:text-gray-400">© 2023 Meraki UI. All Rights Reserved.</p>
    </footer>
</section> */}
...
// <div className="top-[0] z-[1000] left-[0] fixed h-[100vh] w-[100vw] bg-gray-800">
//       {element.type === "photo" ? (
//         <div className="flex justify-center items-center w-[50vw]">
//           <img src={element.photo} alt="" />
//         </div>
//       ) : (
//         <div className="flex flex-col justify-center items-center mx-[25%] w-[50vw] h-[100vh]">
//           <button onClick={() => Play()} className="mb-4">Play</button>
//           <video src={element.photo} ref={videoref} className="w-[90%] h-[100vh]" />
//         </div>
//       )}